    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          {/* Centering wrapper — sits on top of backdrop, does not intercept clicks */}
          <div className="fixed inset-0 z-[101] flex items-center justify-center p-4 pointer-events-none">
            ...
            >
              <div className="bg-white dark:bg-[#1a1a1a] border border-black/[0.07] dark:border-white/[0.07] rounded-2xl p-6 shadow-2xl">
                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <button
                    onClick={onCancel}
                    className="text-black/25 dark:text-white/25 hover:text-black dark:hover:text-white transition-colors mt-0.5"
                  >
                    <X size={18} />
                  </button>
                </div>
                ...
                <div className="flex gap-2 mb-5 p-3 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700/40">
                  ...
                  <p className="text-[12px] text-amber-800 dark:text-amber-300 leading-relaxed">
                    <strong>Testnet demo.</strong> The agent will execute transactions autonomously. You can pause at any time.
                  </p>
                </div>
